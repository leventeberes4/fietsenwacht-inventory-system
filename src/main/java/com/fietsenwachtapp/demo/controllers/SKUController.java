...
public class SKUController {
    ...
    public ResponseEntity<String> bulkUploadSKUs(@RequestParam("file") MultipartFile file) throws IOException {
        return ResponseEntity.ok("Imported " + skuService.bulkAddFromFile(file,true) + " SKUs");
    }
}
